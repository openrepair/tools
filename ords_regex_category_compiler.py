...
if __name__ == "__main__":
    ...
    testterms = pd.read_csv(pathfuncs.DATA_DIR + "/ords_testdata_common_products.csv")
    rxelems = pd.read_csv(pathfuncs.DATA_DIR + "/product_category_regex_elements.csv")
    ...
    results.to_csv(pathfuncs.OUT_DIR + "/product_category_regexes.csv", index=False)
