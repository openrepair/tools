...
CREATE TABLE `ords_problem_translations` (
  ...
  `language_known` varchar(2) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci,
  `translator` varchar(32) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci,
  `language_detected` varchar(2) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci,
